...
;
const metadata = {
    title: "BarberBook - Book Your Perfect Haircut",
    description: "Book appointments with top barbers in your area. Find the perfect barber, select services, and pay online all in one place."
};
